...
public class CenterEmpleado extends JPanel {
	...
	private void init() {
		...
		name = new JTextField("DANIEL FELIPE");
		...
		cedula = new JTextField("34325435634");
		...
		direccion = new JTextField("TRANSVERSAL 33-A");
		...
		telefono = new JTextField("31245678");
		...
		cargo = new JTextField("Ingeniero");
		...
		foto = new JLabel();
		imageIcon = new ImageIcon("src/images/3.png");
		foto.setBounds(500, 30, 250, 250);
		icon = new ImageIcon(imageIcon.getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT));
		foto.setIcon(icon);
