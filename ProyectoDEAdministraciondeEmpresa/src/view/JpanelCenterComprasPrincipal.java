...
public class JpanelCenterComprasPrincipal extends JPanel {
	JLabel jLabel = new JLabel("Compras");
	...
	private String[] cabezera = { "Nombre del Producto", "Precio de compra del producto", "Unidades Compradas", "Total"};
	ImageIcon imageIcon;
	Icon icon;

	public JpanelCenterComprasPrincipal() {
		init();
